...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; connect-src 'self' https: wss:; img-src 'self' data:; font-src 'self' data: https:; style-src 'self' 'unsafe-inline' https:; script-src 'self' 'unsafe-inline'",
  );
